...
export function SignUpPage({ isOpen, onOpen, onClose, lOpen }) {
  ...
  return (
    <>
      <Button bg={"none"} w="100%" onClick={onOpen}>
        SignUp
      </Button>
      ...
      >
        <ModalContent
          ...
          //    backgroundColor="red"
        >
          <Box w={"600px"} bg={"#fa832a"} display={"flex"}>
            <Box border={"1px solid teal"} w={"50%"}>
              ...
              <ModalFooter>
                ...
                <Button onClick={() => (lOpen(), onClose())}>
                  <LoginPage />
                </Button>
              </ModalFooter>
            </Box>
            <Box w={"50%"} border={"0px solid red"} height={"100%"}>
